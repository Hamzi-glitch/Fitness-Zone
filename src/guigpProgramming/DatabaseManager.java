...
public class DatabaseManager {
    ...
    private static final String password = "hariri_05" ;               
    ...
    public boolean addMember (Member member){
        String sql = "INSERT INTO Member (fullName,contactNum,type,rating,duration,totalCharge) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateMember(Member member) {
        ...
        String sql = "UPDATE Member SET fullName=?, contactNum=?, type=?, rating=?, duration=?, totalCharge=? WHERE fullName=?";
    ...
    public boolean deleteMember(String name) {
        ...
        String sql = "DELETE FROM Member WHERE fullName=?";
